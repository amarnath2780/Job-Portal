...
from seeker.views import SearchBarFilter ,AppliedJobByMe,ChangeAppliedJobStatus
...
router.register(r'all-subscription', SubscriptionViewAll , basename='all-subscriptions')
...
urlpatterns = [
    ...
    path('change-job-status/',  ChangeAppliedJobStatus.as_view() , name='offer-letter'),
]
